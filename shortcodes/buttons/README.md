...
use this new version instead <https://github.com/maslopiotr/hugo-modules/tree/master/shortcodes/button>
...
```toml
[[imports]]
path = "github.com/maslopiotr/hugo-modules/shortcodes/buttons"
```
